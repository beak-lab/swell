...
define([
    ...
    function(App, $) {
        ...
        before(function () {
            // Create test fixture.
            this.$fixture = $('<div id=\'challenge-view-fixture\'></div>');
        });
        ...
        beforeEach(function () {
            ...
            var entities = App.request('challenge:entities');
            if (entities !== null) {
                App.log('Creating view: ', contextName, 1);
                this.view = new App.ChallengeApp.List.View.Challenge({
                    el: this.$fixture,
                    collection: entities
                });
                this.view.render();
        ...
        describe('List view', function() {
            ...
            it('can render challengeList', function () {
                App.log('this.$fixture.html(): ' + this.$fixture.html(), contextName, 1);
                expect(this.$fixture.html()).to.contain('challenge_list');
            });
...
//                if (items !== null) {
//                    var SOMEMODULE = new App.ChallengeApp.List.Challenge({
//                        collection: entities
//                    });
//                }
//
