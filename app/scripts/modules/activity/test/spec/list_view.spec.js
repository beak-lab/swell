...
define([
    ...
    function(App, $) {
        var contextName = 'ActivityApp.List.View';

        before(function () {
            // Create test fixture.
            this.$fixture = $('<div id=\'activity-view-fixture\'></div>');
        });
        ...
        beforeEach(function () {
            ...
            var entities = App.request('activity:entities');
            if (entities !== null) {
                App.log('Creating view: ', contextName, 1);
                this.view = new App.ActivityApp.List.View.Activity({
                    el: this.$fixture,
                    collection: entities
                });
                this.view.render();
        ...
        describe('List view', function() {
            ...
            it('can render activityList', function () {
                App.log('this.$fixture.html(): ' + this.$fixture.html(), contextName, 1);
                expect(this.$fixture.html()).to.contain('activity_list');
            });
...
//                if (items !== null) {
//                    var SOMEMODULE = new App.ActivityApp.List.Activity({
//                        collection: entities
//                    });
//                }
//
