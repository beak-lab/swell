...
requirejs.config({
    paths: {
        ...
        'challenge_activity_view'       : 'modules/activity/challenge/view',
        'challenge_activity_controller' : 'modules/activity/challenge/controller',
        'activity_entity'               : 'modules/activity/challenge/activity',
